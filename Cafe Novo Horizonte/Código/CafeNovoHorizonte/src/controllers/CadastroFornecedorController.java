...
public class CadastroFornecedorController extends AbstractCadastroController{
	...
	public CadastroFornecedorController(JTextField txNome, JTextField txDocumento, JTextField txInscricaoEstadual,
